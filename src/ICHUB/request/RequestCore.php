...
namespace ICHUB\request;

use ICHUB\core\CoreBase;
use ICHUB\exception\RequestCore_Exception;

class RequestCore extends CoreBase
{
    public $request_url;
    ...
    public $request_class = 'ICHUB\request\RequestCore';

    public $response_class = 'ICHUB\request\ResponseCore';
    public $useragent = 'RequestCore/1.0.0';
